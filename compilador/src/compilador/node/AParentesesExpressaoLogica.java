...
public final class AParentesesExpressaoLogica extends PExpressaoLogica
{
    private PExpressaoLogica _expressaoLogica_;

    public AParentesesExpressaoLogica()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AParentesesExpressaoLogica(
    ...
    {
        ((Analysis) sw).caseAParentesesExpressaoLogica(this);
    }
